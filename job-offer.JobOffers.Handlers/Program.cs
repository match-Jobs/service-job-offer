...
using job_offer.JobOffers.Common.Infra.NSB;
using job_offer.JobOffers.Command.Infra.Persistence.NHibernate.Mappings;
...
namespace job_offer.Postulations.Handlers
{
    class Program
    {
        ...
        {
            Console.Title = "job-offer.JobOffers";
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
          ...
          {
              var endpointConfiguration = ConfigureEndpoint("job-offer.JobOffers");
        ...
        private static Configuration AddFluentMappings(Configuration nhConfiguration, string stringConnection)
        {
            return Fluently
                ...
                .Mappings(cfg =>
                {
                    cfg.FluentMappings.AddFromAssembly(typeof(JobOfferMap).Assembly);
